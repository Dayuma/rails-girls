...
class ProcesosControllerTest < ActionController::TestCase
  ...
  test "should create proceso" do
    assert_difference('Proceso.count') do
      post :create, proceso: { description: @proceso.description, name: @proceso.name, picture: @proceso.picture, text: @proceso.text }
    end
  ...
  test "should update proceso" do
    patch :update, id: @proceso, proceso: { description: @proceso.description, name: @proceso.name, picture: @proceso.picture, text: @proceso.text }
    assert_redirected_to proceso_path(assigns(:proceso))
  end
